...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2016 at 07:03 AM
...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `spesifikasi`, `id_kategori`, `jumlah`, `sisa_stok`, `satuan`, `id_inventaris`) VALUES
('B0001', 'ASUS ROG RG-808X', '- core i7 hasswell\r\n- ram ddr5 8gb\r\n- vga nvidia geforce 8GB\r\n- screen 15.6"\r\n', 'K002', 2, 0, 'UNIT', 'BM01');
...
INSERT INTO `detail_barang` (`id_detail`, `id_barang`, `nama_detail`, `spesifikasi`, `id_kategori`, `id_inventaris`, `perangkat`, `IP`, `id_pemeliharaan`, `id_penempatan`, `id_windows`, `id_antivirus`, `id_office`, `id_lain`, `status`) VALUES
('B0001.1', 'B0001', 'ASUS ROG RG-808X', '- core i7 hasswell\r\n- ram ddr5 8gb\r\n- vga nvidia geforce 8GB\r\n- screen 15.6"\r\n', 'K002', 'BM01', '', '182.168.0.1', '', '9120', 'W08', 'AA03', 'O04', '', 'distribusi'),
('B0001.2', 'B0001', 'ASUS ROG RG-808X', '- core i7 hasswell\r\n- ram ddr5 8gb\r\n- vga nvidia geforce 8GB\r\n- screen 15.6"\r\n', 'K002', 'BM01', '', '', '', '', '', '', '', '', '');
...
CREATE TABLE `detail_sparepart` (
  `id_detsparepart` varchar(25) NOT NULL,
...
('k002', '2016-11-01', '08:00:00', '2016-11-02', '08:15:00', 'aaaa', 'bbbb', '', 'B0001.1', '9101'),
