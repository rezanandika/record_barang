...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2016 at 08:47 AM
...
INSERT INTO `antivirus` (`id_antivirus`, `nama`) VALUES
('AA01', 'AVIRA'),
('AA02', 'SMADAV'),
('AA03', 'ESET NOD32'),
('AA04', 'AVG'),
...
('B0001', 'ASUS ROG GT808-X', '- intel core i7\r\n- nvidia geforce 980x\r\n- screen 15.6"\r\n- RAM ddr5 8GB', 'LAPTOP', 3, 'UNIT', 'BARANG MODAL');
...
INSERT INTO `detail_barang` (`id_detail`, `id_barang`, `nama`, `spesifikasi`, `id_kategori`, `perangkat`, `IP`, `id_pemeliharaan`, `id_penempatan`, `id_inventaris`) VALUES
('B0001.1', 'B0001', 'ASUS ROG GT808-X', '- intel core i7\r\n- nvidia geforce 980x\r\n- screen 15.6"\r\n- RAM ddr5 8GB', 'LAPTOP', 'Antivirus : AVIRA, </br>WIN XP 64BIT, MICROSOFT OFFICE 2003, .', '182.168.0.1', '', 'KLINIK GIGI', 'BARAN'),
('B0001.2', 'B0001', 'ASUS ROG GT808-X', '- intel core i7\r\n- nvidia geforce 980x\r\n- screen 15.6"\r\n- RAM ddr5 8GB', 'LAPTOP', '', '', '', '', 'BARAN'),
('B0001.3', 'B0001', 'ASUS ROG GT808-X', '- intel core i7\r\n- nvidia geforce 980x\r\n- screen 15.6"\r\n- RAM ddr5 8GB', 'LAPTOP', '', '', '', '', 'BARAN');
...
INSERT INTO `office` (`id_office`, `nama`) VALUES
('O01', 'LIBRE OFFICE'),
...
INSERT INTO `windows` (`id_windows`, `nama`) VALUES
('W01', 'WIN XP 32BIT'),
('W02', 'WIN XP 64BIT'),
('W03', 'WIN 7 PRO 32BIT'),
('W04', 'WIN 7 PRO 64BIT'),
