...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2016 at 08:57 AM
...
('B0001', 'asus', 'ok', 'K002', 3, 'UNIT', 'I01'),
('B0002', 'printer epson 330', 'oke', 'K003', 2, 'UNIT', 'I01'),
('B0003', 'printer epson 390', 'ooooooo', 'K003', 2, 'UNIT', 'I01');
...
INSERT INTO `detail_barang` (`id_detail`, `id_barang`, `nama_detail`, `spesifikasi`, `id_kategori`, `id_inventaris`, `perangkat`, `IP`, `id_pemeliharaan`, `id_penempatan`, `id_windows`, `id_antivirus`, `id_office`, `id_lain`) VALUES
('B0001.1', 'B0001', 'asus', 'ok', 'K002', 'I01', '', '182.168.0.2', '', '9101', 'W02', 'AA03', 'O02', ''),
('B0001.2', 'B0001', 'asus', 'ok', 'K002', 'I01', '', '182.168.0.56', '', '9102', 'W04', 'AA02', 'O04', ''),
('B0001.3', 'B0001', 'asus', 'ok', 'K002', 'I01', '', '182.168.0.76', '', '9102', 'W04', 'AA04', 'O04', ''),
('B0002.1', 'B0002', 'printer epson 330', 'oke', 'K003', 'I01', '', '', '', '9101', 'Pilih Windows', 'Pilih Antivirus', 'Pilih Office', ''),
('B0002.2', 'B0002', 'printer epson 330', 'oke', 'K003', 'I01', '', '', '', '', '', '', '', ''),
('B0003.1', 'B0003', 'printer epson 390', 'ooooooo', 'K003', 'I01', '', '', '', '', '', '', '', ''),
('B0003.2', 'B0003', 'printer epson 390', 'ooooooo', 'K003', 'I01', '', '', '', '', '', '', '', '');
...
INSERT INTO `pemeliharaan` (`id_pemeliharaan`, `tgl_mulai`, `jam_mulai`, `tgl_selesai`, `jam_selesai`, `kerusakan`, `penanganan`, `sparepart`, `id_detail`, `id_lokasi`) VALUES
('PP0001', '2016-11-15', '00:00:00', '2016-11-18', '00:00:00', 'Mainboard mati', 'diperlukan adanya penggantian sparepart', '', 'B0001.1', '9101'),
('PP020', '2016-11-24', '01:00:00', '2016-11-25', '01:45:00', 'catridge macet', 'oke', '', 'B0002.1', '9101');
