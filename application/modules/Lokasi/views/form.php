    ...
    <form role="form" action="<?php echo base_url().'index.php/lokasi/insert' ?>" method="POST" enctype="multipart/form-data">
      <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="idkategori" placeholder="Kode Lokasi" name="idlokasi">
                </div>
                <div class="form-group">
                  <label for="nama">Nama Lokasi</label>
                  <input type="text" class="form-control" id="nama" placeholder="Nama Lokasi" name="nama">
                </div>
              <!-- /.box-body -->
