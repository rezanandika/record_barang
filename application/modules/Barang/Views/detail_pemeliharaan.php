              ...
              <tbody>
                 ...
                 <?php foreach($pemeliharaan as $d){ ?>
                  ...
                  <td> </td>
                      ...
                      <td><a href="<?php echo base_url(). 'pemeliharaan/edit/?id=' .$d['id_pemeliharaan']; ?>" title="Edit"><i class="fa fa-pencil text-primary"></i></a>

                        <a href="<?php echo base_url(). 'pemeliharaan/delete/' .$d['id_pemeliharaan'] ?>" title="Hapus"><i class="fa fa-trash text-danger"></i></a></td>
                    </tr>
                 <?php } ?>
