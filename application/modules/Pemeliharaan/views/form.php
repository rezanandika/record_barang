 ...
 <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form method="post" class="form-horizontal" action="<?php echo base_url()."pemeliharaan/insert"; ?>">
                  <div class="box-body">
                   ...
                   <!--  <div class="form-group">
                            ...
                            <div class="box-body">
                              ...
                              <input type="checkbox" value="nonton tv" name="hobi4"> KONEKTOR TV <br/>
                               <div class="col-sm-8">
                                  ...
                                  <?php foreach ($brgpem as $ln) { ?>
                                   
                                        <div class="col-md-6">
                                          <div class="row">
                                              <div class="checkbox">
                                              <label>
                                                <input type="checkbox" name="checks[]"  class="minimal" >
                                                </label>
                                              </div>
                                         </div>
                                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5 input-group">
                         <select class="form-control select2" name="idlokasi" id="idlokasi" onchange="javascript: addText();"">
                         <option>Pilih Barang yang Diganti</option>

                          <?php  foreach($brgpem as $l){ 
                               $sel=""; if(isset($id_brgpemeliharaan)){
                                  if($id_brgpemeliharaan == $l['id_brgpemeliharaan'])
                                    $sel="selected='selected'";} ?>
                         
                          <option value="<?= $l['id_brgpemeliharaan'] ?>" <?php echo $sel ?>><?php echo $l['nama_brgpemeliharaan'] ?></option>
