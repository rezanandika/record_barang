      ...
      <div class="row">
        <div class="col-xs-12 col-lg-8">
			<div class="box">
				...
				<!-- <form action="http://go-laundry.com/demo/admin/pengerjaan/simpan" id="testForm" method="post" accept-charset="utf-8"> -->
				<form action="#" id="testForm" method="post" accept-charset="utf-8">
					<div class="box-body">
					<div class="form-group">
						<label>Nama Status</label>
						<input type="text" class="form-control" name="nama_status" placeholder="Ketik Nama Status Baru.." required="">
					</div>
				</div><!-- /.box-body -->
				<div class="box-footer">
					<input type="submit" name="submit" class="btn btn-primary" value="Simpan">
					<a href="tambah_status.html" class="btn btn-primary">Kembali</a>
				</div>
				</form>                
			</div>
        </div>
