        ...
        <div class="col-md-12">
          <div class="box">
			<div class="box-header">
				<a href="tambah" class="btn btn-primary btn-sm" style="color:#fff; margin-top:5px; margin-left:0px">Tambah Baru</a>                                </div><!-- /.box-header -->
			<div class="box-body table-responsive">
				<div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid"><div class="row"><div class="col-xs-6"><div id="example1_length" class="dataTables_length"><label><select size="1" name="example1_length" aria-controls="example1"><option value="10" selected="selected">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> records per page</label></div></div><div class="col-xs-6"><div class="dataTables_filter" id="example1_filter" style="float:right"><label>Search: <input type="text" aria-controls="example1"></label></div></div></div><table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
					<thead>
						<tr role="row"><th width="20" class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="No: activate to sort column descending" style="width: 19px;">No</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Nama Layanan: activate to sort column ascending" style="width: 262px;">Nama Layanan</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Unit: activate to sort column ascending" style="width: 109px;">Unit</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Harga Normal: activate to sort column ascending" style="width: 248px;">Harga Normal</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Harga Express: activate to sort column ascending" style="width: 251px;">Harga Express</th><th width="10" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Edit: activate to sort column ascending" style="width: 24px;">Edit</th><th width="10" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Hapus: activate to sort column ascending" style="width: 39px;">Hapus</th></tr>
					</thead>
					
					<tfoot>
						<tr><th rowspan="1" colspan="1">No</th><th rowspan="1" colspan="1">Nama Kategori</th><th rowspan="1" colspan="1">Jenis</th><th rowspan="1" colspan="1">Edit</th><th rowspan="1" colspan="1">Hapus</th></tr>
					</tfoot>
				<tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
							<td align="center" class=" sorting_1">1</td>
							<td class=" ">Cuci Setrika</td>
							<td class=" ">KG</td>
							<td class=" ">Rp 4,000</td>
							<td class=" ">Rp 6,000</td>
							<!--<td align="center" class=" "><a href="http://go-laundry.com/demo/admin/layanan/edit/11"><i class="fa fa-pencil-square-o"></i></a></td>
							<td align="center" class=" "><a href="http://go-laundry.com/demo/admin/layanan/hapus/11" onclick="return ConfirmDelete();"><i class="fa fa-trash-o"></i></a></td>-->
							...
							<td class=" ">Cuci</td>
							<td class=" ">KG</td>
							<td class=" ">Rp 3,000</td>
							<td class=" ">Rp 4,500</td>
							<!--<td align="center" class=" "><a href="http://go-laundry.com/demo/admin/layanan/edit/12"><i class="fa fa-pencil-square-o"></i></a></td>
							<td align="center" class=" "><a href="http://go-laundry.com/demo/admin/layanan/hapus/12" onclick="return ConfirmDelete();"><i class="fa fa-trash-o"></i></a></td>-->
							<td align="center" class=" "><a href="#"><i class="fa fa-pencil-square-o"></i></a></td>
							<td align="center" class=" "><a href="#" onclick="return ConfirmDelete();"><i class="fa fa-trash-o"></i></a></td>
						</tr><tr class="odd">
							...
							<td class=" ">Rp 3,000</td>
							<td class=" ">Rp 4,500</td>
							<!--<td align="center" class=" "><a href="http://go-laundry.com/demo/admin/layanan/edit/13"><i class="fa fa-pencil-square-o"></i></a></td>
							<td align="center" class=" "><a href="http://go-laundry.com/demo/admin/layanan/hapus/13" onclick="return ConfirmDelete();"><i class="fa fa-trash-o"></i></a></td>-->
							<td align="center" class=" "><a href="#"><i class="fa fa-pencil-square-o"></i></a></td>
							<td align="center" class=" "><a href="#" onclick="return ConfirmDelete();"><i class="fa fa-trash-o"></i></a></td>
						</tr></tbody></table><div class="row"><div class="col-xs-6"><div class="dataTables_info" id="example1_info">Showing 1 to 6 of 6 entries</div></div><div class="col-xs-6"><div class="dataTables_paginate paging_bootstrap" style="float:right;"><ul class="pagination"><li class="prev disabled"><a href="#">← Previous</a></li><li class="active"><a href="#">1</a></li><li class="next disabled"><a href="#">Next → </a></li></ul></div></div></div></div>
