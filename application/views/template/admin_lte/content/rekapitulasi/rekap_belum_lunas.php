          ...
          <div class="box">
				...
				<div class="box-body table-responsive">
					...
					<table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
						<thead>
							<tr role="row"><th width="20" class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="No: activate to sort column descending" style="width: 19px;">No</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 90px;">Customer</th><th style="text-align: center; width: 97px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="No Invoice: activate to sort column ascending">No Invoice</th><th style="text-align: center; width: 52px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Jenis: activate to sort column ascending">Jenis</th><th style="text-align: center; width: 88px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Sub Total: activate to sort column ascending">Sub Total</th><th style="text-align: center; width: 67px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Diskon: activate to sort column ascending">Diskon</th><th style="text-align: center; width: 51px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Total: activate to sort column ascending">Total</th><th style="text-align: center; width: 75px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Dibayar: activate to sort column ascending">Dibayar</th><th style="text-align: center; width: 43px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Sisa: activate to sort column ascending">Sisa</th><th style="text-align: center; width: 178px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Status Pembayaran: activate to sort column ascending">Status Pembayaran</th><th style="text-align: center; width: 58px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Bayar: activate to sort column ascending">Bayar</th><th style="text-align: center; width: 64px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Hapus: activate to sort column ascending">Hapus</th></tr>
						</thead>
						
					<tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd"><td valign="top" colspan="12" class="dataTables_empty">No data available in table</td></tr></tbody></table>
							
							<div class="row"><div class="col-xs-6"><div class="dataTables_info" id="example1_info">Showing 0 to 0 of 0 entries</div></div><div class="col-xs-6"><div class="dataTables_paginate paging_bootstrap"><ul class="pagination"><li class="prev disabled"><a href="#">← Previous</a></li><li class="next disabled"><a href="#">Next → </a></li></ul></div></div></div>
							<p class="help-block"><em><strong>Note:</strong> <br>Pada bagian ini anda bisa melihat seluruh rekapitulasi transaksi <strong>Laundry Belum Lunas.</strong></em></p>
							</div><!-- /.box-body -->
			</div>
          <!-- /.box -->
