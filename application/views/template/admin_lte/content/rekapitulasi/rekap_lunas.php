          ...
          <div class="box">
			...
			<div class="box-body table-responsive">
				...
				<table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
					<thead>
						<tr role="row"><th width="20" class="sorting_asc" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="No: activate to sort column descending" style="width: 19px;">No</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 74px;">Customer</th><th style="text-align: center; width: 79px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="No Invoice: activate to sort column ascending">No Invoice</th><th style="text-align: center; width: 41px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Jenis: activate to sort column ascending">Jenis</th><th style="text-align: center; width: 71px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Sub Total: activate to sort column ascending">Sub Total</th><th style="text-align: center; width: 53px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Diskon: activate to sort column ascending">Diskon</th><th style="text-align: center; width: 72px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Total: activate to sort column ascending">Total</th><th style="text-align: center; width: 80px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Dibayar: activate to sort column ascending">Dibayar</th><th style="text-align: center; width: 80px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Sisa: activate to sort column ascending">Sisa</th><th style="text-align: center; width: 148px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Status Pembayaran: activate to sort column ascending">Status Pembayaran</th><th style="text-align: center; width: 114px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Catatan: activate to sort column ascending">Catatan</th><th style="text-align: center; width: 51px;" class="sorting" role="columnheader" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Hapus: activate to sort column ascending">Hapus</th></tr>
					</thead>
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
							...
							<td style="text-align:center" class=" "><a href="invoice">94</a></td>
							<td class=" ">Tunai</td>
						...
						<p class="help-block"><em><strong>Note:</strong> <br>Pada bagian ini anda bisa melihat seluruh rekapitulasi transaksi <strong>Laundry</strong> yang telah dibayar <strong>Lunas.</strong></em></p>
			</div><!-- /.box-body -->
		</div>
          <!-- /.box -->
