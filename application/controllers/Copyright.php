...
class Copyright extends Admin_Controller implements ControllerInterface{
	public function __construct(){
		parent::__construct();
		$this->load->model("Copyright_model", 'transaksi');
	...
	function index(){
		...
		$data['content']	= 'content/copyright/index';
		$this->transaksi->select('transaksi.*');
		$this->transaksi->order_by('transaksi.id','DESC');
