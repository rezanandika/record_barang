...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2016 at 08:46 AM
...
INSERT INTO `detail_barang` (`id_detail`, `id_barang`, `nama_detail`, `spesifikasi`, `id_kategori`, `id_inventaris`, `perangkat`, `IP`, `id_pemeliharaan`, `id_penempatan`, `id_windows`, `id_antivirus`, `id_office`) VALUES
('B0001.1', 'B0001', 'asus', 'ok', 'K002', 'I01', '', '182.168.0.1', '', '9101', 'W02', 'AA02', 'O02'),
('B0001.2', 'B0001', 'asus', 'ok', 'K002', 'I01', '', '', '', '', '', '', ''),
('B0001.3', 'B0001', 'asus', 'ok', 'K002', 'I01', '', '', '', '', '', '', '');
...
INSERT INTO `pemeliharaan` (`id_pemeliharaan`, `tgl_mulai`, `waktu_mulai`, `tgl_selesai`, `waktu_selesai`, `kerusakan`, `penanganan`, `id_detail`, `id_lokasi`) VALUES
